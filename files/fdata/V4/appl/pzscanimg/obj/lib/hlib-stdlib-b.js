...
// =======================================================================
HlibStdlibB = function()
 {
 HlibCompat.call(this);
...
//------------------------------------------------------------------------
 this.doResized = function(lib)
  {
  for (var i = 0; i < arguments.length; i++)
   {
   lib = arguments[i];
   if (lib.resizeElements) lib.resizeElements();
   }
  }


//------------------------------------------------------------------------
 this.newPseudoEvent = function(id,typ)
  {
  var src = {};
  src.id = id;
  var e = {};
