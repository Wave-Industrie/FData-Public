...
//-----
 this.newTable2 = function(d0,appl_defines,global_defines)
  {
  return(new this.comps.Table2(d0,appl_defines,global_defines));
  };
...
*/
  ...
  if (e0.className.indexOf("jt3") >= 0)
   {
   this.newTable2(e0,defs.ID[e0.id],defs);
   return;
   }
...
// =======================================================================
_comps_.Table2 = function(p0,appl_defines,all_defines)
 {
 HlibStdlibA.call(this);
